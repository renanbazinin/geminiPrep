...
const copy = {
  en: {
    ...
    cacheDescription: "Create and inspect a Gemini 3 explicit cache, control its TTL, use it, and prove the cache hit.",
    cacheDetails: ["Gemini 3 explicit caching", "TTL and expireTime lifecycle", "cachedContentTokenCount evidence"],
    live: "Live API",
  ...
  he: {
    ...
    cacheDescription: "יצירה ובדיקה של מטמון מפורש עבור Gemini 3, שליטה ב־TTL, שימוש והוכחת פגיעת מטמון.",
    cacheDetails: ["מטמון מפורש ב־Gemini 3", "מחזור חיים של TTL ו־expireTime", "הוכחה באמצעות cachedContentTokenCount"],
    live: "API חי",
